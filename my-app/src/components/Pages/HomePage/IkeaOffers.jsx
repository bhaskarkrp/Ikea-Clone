    ...
    return (
        <div className={style.offer}>
            <div className={style.product} gridArea="a" >
                <img src={pic1 ? o1 : back} alt="Loading" onMouseEnter={() => setPic1(false)} onMouseLeave={() => setPic1(true)} />
                <div>
            ...
            <div className={style.product} gridArea="b" >
                <img src={pic2 ? o2 : back} alt="Loading" onMouseEnter={() => setPic2(false)} onMouseLeave={() => setPic2(true)} />
                <div>
                    <h4>Ikea family price</h4>
                    <h3>FLODA</h3>
                    <div>Soy sauce bottle</div>
            ...
            <div className={style.product} gridArea="c" >
                <img src={pic3 ? o3 : back} alt="Loading" onMouseEnter={() => setPic3(false)} onMouseLeave={() => setPic3(true)} />
                <div>
                    <h4>Ikea family price</h4>
                    <h3>FLODA</h3>
                    <div>Soy sauce bottle</div>
            ...
            <div className={style.product} gridArea="d">
                <img src={pic4 ? o4 : back} alt="Loading" onMouseEnter={() => setPic4(false)} onMouseLeave={() => setPic4(true)} />
                <div>
                    <h4>Ikea family price</h4>
                    <h3>FLODA</h3>
                    <div>Soy sauce bottle</div>
